...
const Header = () => {
  ...
  const navigateTo = (e, path, name) => {
    ...
    setActiveLink(name || path); // Update active link based on name or path
    setIsOffcanvasOpen(false);
    setOpenMobileDropdown(null);
    // Optionally dispatch popstate event to trigger app updates
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      {/* Top Header Bar */}
      <div className="bg-[#234159] text-gray-300 text-sm py-2">
      ...
      <nav
        className={`w-full transition-all duration-300 ${
          isScrolled ? "bg-white shadow-lg py-3" : "bg-white py-3"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex justify-between items-center">
              ...
              <nav className="flex flex-col space-y-2">
                ...
                <div className="mt-8">
                  <a
                    ...
                    onClick={(e) => navigateTo(e, "/support", "Support")}
                  >
                    Support KU
                  </a>
                </div>
